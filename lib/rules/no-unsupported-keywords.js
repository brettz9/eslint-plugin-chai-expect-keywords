...
export default {
  ...
  create (context) {
    ...
    const allKeywords = new Set(keywords.CHAI.concat(
      ...
      options.allowChaiExclude ? keywords.CHAI_EXCLUDE : []
    ));
